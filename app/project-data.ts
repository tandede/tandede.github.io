...
export const featuredProjects: FeaturedProject[] = [
  ...
  },
  {
    ...
    contribution: '我参与经验整合方向的研究与实验分析：在七个带可执行验证器的交互游戏中，对比 History ICL、Summary Memory 与参数训练，分析 Agent 的自我判断能否转化为严格 held-out 条件下的真实增益。',
  ...
  },
  {
    ...
    contribution: '我参与完整仓库生成基准的研究与实验分析：围绕真实需求文档、空工作区、隔离执行环境与上游测试组织统一评测链路，并分析 Agent 在长程规划、跨文件一致性和依赖管理上的失败表现。',
