...
export const openSourceProjects: OpenSourceProject[] = [
  ...
  },
  {
    ...
    release: {
      label: 'v0.35.0',
      title: 'PR #15721 已进入 ComfyUI v0.35.0 版本',
      href: 'https://github.com/Comfy-Org/ComfyUI/tree/v0.35.0',
      credit: 'ComfyUI v0.35.0 的版本标签位于 PR #15721 合并提交之后，并完整包含该 Porter–Duff 透明混合修复。',
      steps: ['Porter–Duff 透明混合修复', 'v0.35.0 标签包含合并提交', '版本标签已创建'],
      linkLabel: '查看版本标签',
    },
  ...
  },
  {
    ...
    release: {
      label: '1.15.19',
      title: 'PR #7068 已随 CrewAI 1.15.19 正式发布',
      href: 'https://github.com/crewAIInc/crewAI/releases/tag/1.15.19',
      credit: 'CrewAI 1.15.19 的 Bug Fixes 直接列出“Preserve reusable scope configs in memory”，版本 Contributors 名单同时包含 @tandede。',
      steps: ['Memory scope 配置复用修复', 'Release Notes 直接列出该修复', 'Contributors 官方署名'],
    },
  ...
  },
  {
    ...
    release: {
      label: 'v0.1.8b1',
      title: 'PR #2315 已进入 MarkItDown v0.1.8b1 预发布版',
      href: 'https://github.com/microsoft/markitdown/releases/tag/v0.1.8b1',
      credit: 'v0.1.8b1 预发布说明直接列出 PR #2315，并在 New Contributors 中记录 @tandede 的首次贡献。',
      steps: ['Windows 编码盘符 URI 修复', 'Release Notes 收录 PR #2315', 'New Contributors 官方署名'],
      linkLabel: '查看预发布版本',
    },
  ...
  },
  {
    ...
    release: {
      label: 'v1.37.1',
      title: 'PR #778 已随 evo v1.37.1 发布',
      href: 'https://github.com/MichaelGrupp/evo/tree/v1.37.1',
      credit: 'evo v1.37.1 的官方 Tag message 直接记录连续距离区间补齐修复，版本标签完整包含 PR #778 的合并提交。',
      steps: ['连续距离区间补齐', 'v1.37.1 标签包含合并提交', 'Tag message 直接记录该修复'],
      linkLabel: '查看版本标签',
    },
  ...
  },
  {
    ...
    release: {
      label: 'core 1.6.2',
      title: 'Issue #39821 相关修复已随 langchain-core 1.6.2 正式发布',
      href: 'https://github.com/langchain-ai/langchain/releases/tag/langchain-core%3D%3D1.6.2',
      credit: 'langchain-core 1.6.2 Release Notes 直接列出 Bedrock Converse 内容只读修复 PR #40022；对应合并提交保留 Zhewen Tan 的共同作者署名。',
      steps: ['Bedrock content_blocks 只读修复', 'Release Notes 收录 PR #40022', 'langchain-core 1.6.2 已发布'],
    },
  ...
  },
  {
    ...
    release: {
      label: 'v1.17.0',
      title: 'PR #2551 相关修复已随 Instructor v1.17.0 正式发布',
      href: 'https://github.com/567-labs/instructor/releases/tag/v1.17.0',
      credit: 'Instructor v1.17.0 Release Notes 在 Gemini safety settings 条目中直接列出 PR #2551，并说明调用者配置在应用默认阈值前会被复制。',
      steps: ['Gemini 安全配置只读修复', 'Release Notes 直接列出 PR #2551', '正式版本已发布'],
    },
  ...
  },
  {
    ...
    release: {
      label: 'v0.22.1',
      title: 'PR #4512 已随 OpenAI Agents SDK v0.22.1 正式发布',
      href: 'https://github.com/openai/openai-agents-python/releases/tag/v0.22.1',
      credit: 'v0.22.1 Release Notes 直接列出可视化重名节点修复 PR #4512，并在 New Contributors 中记录 @tandede 的首次贡献。',
      steps: ['重名节点身份保留修复', 'Release Notes 收录 PR #4512', 'New Contributors 官方署名'],
    },
  ...
  },
  {
    ...
    release: {
      label: 'v0.29.0',
      title: 'PR #9615 已随 TorchVision v0.29.0 正式发布',
      href: 'https://github.com/pytorch/vision/releases/tag/v0.29.0',
      credit: 'TorchVision v0.29.0 的 Bug fixes 直接列出 JPEG 非连续批次修复 PR #9615，Contributors 名单同时记录 Zhewen。',
      steps: ['JPEG 非连续批次修复', 'Release Notes 收录 PR #9615', 'Contributors 官方署名'],
    },
