...
export default function OpenSourceMemberships() {
  return <section className="membership-panel" data-reveal data-motion>
    <header className="membership-identity">
      ...
      <div className="membership-summary"><strong>{repositoryCount}</strong><div><span>PUBLIC REPOSITORIES</span><p>受 Olivier Michel 邀请加入 Cyberbotics Ltd. 的 Committers 团队，参与覆盖 {repositoryCount} 个公开仓库的组织协作。具体代码工作独立收录在下方 PR Contributions。</p></div></div>
